...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-[#0a0417] px-4 py-10">
      ...
      <svg width="170" height="140" viewBox="0 0 400 330" role="img" aria-label="Edimo Le Bayeur" className="mb-6">
        <g transform="translate(100,20)">
          ...
          <path d="M80,175 L80,140 A20,20 0 0 1 120,140 L120,175 Z" fill="#FFD400" />
        </g>
        <text
          x="200"
          y="270"
      ...
      <div className="w-full max-w-md rounded-xl bg-card p-6 shadow-lg sm:p-8">{children}</div>
    </div>
  )
}
